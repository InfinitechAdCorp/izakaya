...
export default function CTASection() {
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-green-800 via-green-700 to-green-900">
      <div className="relative container mx-auto px-4 text-center">
        ...
        <h2 className="text-5xl md:text-6xl font-bold mb-6 text-white drop-shadow-lg">
          ...
          <br />
          <span className="text-amber-200 drop-shadow-xl">Authentic Korean Flavors?</span>
        </h2>
        ...
        <p className="text-xl md:text-2xl mb-10 text-white/90 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
          ...
          <br />
          <span className="text-amber-200 font-medium">Delicious Korean Food</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Button
            asChild
            size="lg"
            className="text-lg px-10 py-7 bg-white/95 backdrop-blur-sm text-green-800 hover:bg-white hover:scale-105 transition-all duration-300 shadow-2xl border-2 border-white/20 font-semibold"
          >
