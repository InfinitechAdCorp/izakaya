...
export default function HeroSection() {
  ...
  useEffect(() => {
    const fetchFeaturedProducts = async () => {
      try {
        // Call Laravel API directly (temporary fix)
        ...
        if (response.ok) {
          ...
          // If we have products, use them; otherwise fall back to defaults
          if (products.length > 0) {
            setDishes(products.slice(-3)) // Take last 3 products
          } else {
            // Fallback to default dishes if no featured products
            setDishes([
              {
                id: 1,
                name: "Bibimbap",
                description: "A wholesome rice bowl with fresh vegetables, beef, and spicy gochujang sauce.",
                price: 0,
                category: "Rice Dishes",
                image_url: "/korean-bibimbap-rice-bowl-with-colorful-vegetables.jpg",
                is_featured: true,
              },
              {
                id: 2,
                name: "Korean BBQ",
                description: "Premium grilled meats served with traditional banchan and dipping sauces.",
                price: 0,
                category: "BBQ",
                image_url: "/korean-bbq-grilled-meat-on-table-grill.jpg",
                is_featured: true,
              },
              {
                id: 3,
                name: "Kimchi Jjigae",
                description: "Traditional spicy kimchi stew, simmered to perfection in a stone pot.",
                price: 0,
                category: "Stew",
                image_url: "/korean-kimchi-stew-in-stone-pot.jpg",
                is_featured: true,
              },
            ])
          }
  ...
  // Auto-slide carousel (pause when modal is open)
  useEffect(() => {
  ...
  const handleCardClick = (dish: Product, offset: number) => {
    // Only allow clicking the active card (offset === 0)
    if (offset === 0) {
  ...
  return (
    <>
      <section className="relative min-h-[70vh] lg:min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-stone-900 via-green-900 to-stone-950 overflow-hidden py-8 lg:py-0">
        {/* Traditional Korean patterns overlay */}
        <div className="absolute inset-0 pointer-events-none opacity-20">
          <div className="absolute top-10 left-5 w-20 h-20">
            <svg viewBox="0 0 100 100" className="w-full h-full text-green-400 animate-pulse">
              <pattern id="dancheong1" patternUnits="userSpaceOnUse" width="20" height="20">
                ...
                <circle cx="10" cy="10" r="3" fill="#f59e0b" opacity="0.8" />
              </pattern>
          ...
          <div className="absolute top-1/4 right-10 w-32 h-16 opacity-15">
            <svg viewBox="0 0 120 60" className="w-full h-full text-amber-400">
              <path
          ...
          >
            <svg viewBox="0 0 100 100" className="w-full h-full">
              <circle cx="50" cy="50" r="45" fill="none" stroke="#22c55e" strokeWidth="2" opacity="0.6" />
              <path
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
              ...
              <div className="flex-1 text-center lg:text-left text-white order-2 lg:order-1 w-full">
                ...
                <div className="mb-4 lg:mb-8 flex justify-center lg:justify-start">
                  <Image
                    src="/images/bonga-logo.jpg"
                    alt="BONGA Restaurant Logo"
                    width={200}
                    height={140}
                ...
                <p className="text-lg md:text-2xl lg:text-3xl font-light text-stone-200 mb-4 lg:mb-8">
                  "Where Tradition Meets Authentic Taste"
                </p>

                <p className="text-sm md:text-lg lg:text-xl mb-6 lg:mb-8 text-stone-300 italic leading-relaxed px-4 lg:px-0">
                  Experience the essence of Korean culinary heritage, crafted with passion and served with the warmth of
                ...
                <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center lg:justify-start px-4 lg:px-0">
                  <Button
                    asChild
                    size="lg"
                    className="bg-gradient-to-r from-green-700 to-green-600 hover:from-green-800 hover:to-green-700 text-base lg:text-lg px-6 lg:px-8 py-5 lg:py-6 shadow-xl text-white border-0"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="text-base lg:text-lg px-6 lg:px-8 py-5 lg:py-6 border-2 border-stone-200 text-stone-100 hover:bg-stone-100 hover:text-stone-900 bg-transparent"
                  >
                          ...
                          >
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/20 shadow-2xl h-full hover:bg-white/15 transition-colors">
                              ...
                              <div className="p-4 lg:p-6 text-left">
                                <h3 className="text-xl lg:text-2xl font-semibold mb-2 lg:mb-3 text-amber-400">{dish.name}</h3>
                                <p className="text-stone-200 text-xs lg:text-base leading-relaxed line-clamp-2 lg:line-clamp-3">
                                  {dish.description}
                                </p>
                                
                                {/* Read More hint - only show on active card */}
                                {isActive && (
                                  <button
                                    className="mt-2 text-amber-400 text-sm lg:text-base font-medium hover:text-amber-300 transition-colors flex items-center gap-1"
                                    onClick={(e) => {
                                      e.stopPropagation()
                                      setSelectedDish(dish)
                                    }}
                      ...
                      {dishes.map((_, i) => (
                        <button
                          ...
                          className={`w-3 h-3 rounded-full transition-all duration-300 ${
                            i === currentSlide ? "bg-amber-400 scale-125" : "bg-white/30 hover:bg-white/50"
                          }`}
      ...
      {selectedDish && (
        ...
        >
          <div 
            className="relative bg-gradient-to-br from-stone-900 to-stone-800 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-amber-400/30 animate-in zoom-in duration-300"
          ...
          >
            ...
            <div className="p-6 md:p-8">
              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-green-700/50 text-green-200 text-sm rounded-full mb-3">
              ...
              <div className="text-stone-200 text-base md:text-lg leading-relaxed space-y-4">
              ...
              <div className="mt-6">
                <Button
                  asChild
                  size="lg"
                  className="w-full bg-gradient-to-r from-green-700 to-green-600 hover:from-green-800 hover:to-green-700 text-white"
                >
